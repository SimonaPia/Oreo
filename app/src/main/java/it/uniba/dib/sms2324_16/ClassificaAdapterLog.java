...
public class ClassificaAdapterLog extends RecyclerView.Adapter<ClassificaAdapterLog.ViewHolder>{
    private List<Bambino> bambinoList;

    public ClassificaAdapterLog(List<Bambino> bambinoList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_class_log, parent, false);
