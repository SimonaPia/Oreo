...
public class SceltaPersonaggioMondoIncantato extends AppCompatActivity {
        ...
        if (user != null) {
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    salvaPersonaggio("Draghetto", "Mondo Incantato");
                }
            });
            ...
            button2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    salvaPersonaggio("Principessa", "Mondo Incantato");
                }
            });
            ...
            button3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    salvaPersonaggio("Elfo", "Mondo Incantato");
                }
            });
