...
public class ScenarioMondoIncantatoActivity extends AppCompatActivity {
    private CollectionReference scenarioCollection;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scenario_mondo_incantato);
        ...
        confermaButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveScenarioChoice("id_genitore", "id_bambino", "Mondo incantato");
                eseguiSalvataggioScenario("Mondo incantato");
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Toast.makeText(ScenarioMondoIncantatoActivity.this,
                                ...
                                Toast.makeText(ScenarioMondoIncantatoActivity.this, "Nessuno scenario trovato", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            // Gestisci eventuali errori durante la lettura dello scenario da Firestore
                            Toast.makeText(ScenarioMondoIncantatoActivity.this, "Errore durante la lettura dello scenario da Firestore", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            // Gestione dell'errore o log quando l'utente non è autenticato
