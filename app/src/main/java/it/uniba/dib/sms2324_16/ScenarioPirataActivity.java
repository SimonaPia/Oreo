...
public class ScenarioPirataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scenario_pirata);
        ...
        confermaButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveScenarioChoice("id_genitore", "id_bambino", "Pirata");
                eseguiSalvataggioScenario("Pirata");
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Toast.makeText(ScenarioPirataActivity.this,
                                ...
                                Toast.makeText(ScenarioPirataActivity.this, "Nessuno scenario trovato", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            // Gestisci eventuali errori durante la lettura dello scenario da Firestore
                            Toast.makeText(ScenarioPirataActivity.this, "Errore durante la lettura dello scenario da Firestore", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            // Gestione dell'errore o log quando l'utente non è autenticato
